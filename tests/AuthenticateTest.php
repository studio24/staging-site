...
class AuthenticateTest extends TestCase
{
    ...
    public function testAuthenticateReturnsTrueWithValidCookie(): void
    {
        $auth = new Authenticate();
        $auth->setPasswordHash($this->testHash);

        // Mirror getUniqueStringForUser(): REMOTE_ADDR:HTTP_USER_AGENT:md5(passwordHash)
        $identifier = '127.0.0.1:PHPUnit Test Agent:' . md5($this->testHash);
