...
Copy the file [staging-site-password.php](wordpress/staging-site.php) to your mu-plugins directory. This ensures the plugin always runs and cannot be removed.
